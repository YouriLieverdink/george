...
- **Alcohol & recovery** (2026-03-06, updated 2026-03-09): Heavy Thursday → HRV crashed 61→31 (50% drop), sleep 6h/47/POOR. Recovery fast: HRV back to 61 next day. Now 4 consecutive drinking nights (Thu heavy, Fri 2, Sat 3, Sun 2). No compounding in morning metrics — each day recovered well (Mon: HRV 68, sleep 9.3h/83/GOOD). Body handles moderate drinking well in isolation, but 4/4 nights is a frequency pattern flagged to athlete. Watch closely as training ramps to 5 sessions/week in Week 2.
