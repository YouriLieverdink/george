...
- **Alcohol & recovery** (2026-03-06, updated 2026-03-16): **Pattern now confirmed twice.** (1) Mar 5 heavy → Mar 6: HRV 61→31 (50% drop), sleep 6h/47/POOR. (2) Mar 12 heavy → Mar 13: HRV 73→26 (64% drop), sleep 3h/23/POOR. Both times: recovery fast — HRV back to baseline within 24–48h. Objective metrics bounce back quickly but Friday after heavy Thursday is a write-off day (devastated sleep + HRV). Planning implication: never schedule a session the day after a known heavy drinking night. Sunday 3 drinks → Monday HRV dipped modestly (68→59) — lighter drinking has smaller but still measurable impact. Next planned drinking: March 20 gala (heavy).
