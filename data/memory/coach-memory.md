...
- **Sleep & social evenings** (2026-03-01, updated 2026-03-12): Consistently gets <8h sleep. Late social evenings (often past midnight) with early work mornings — key recovery limiter. Committed to fixed 7:00 wake-up daily (including weekends, non-negotiable) + in bed by 23:00 on 5+ nights/week. Recognizes some late nights are habit rather than quality social time. Wants to become a morning person again and eventually train before work (loved this in the past). **Wake routine:** Garmin vibration alarm at 06:50, one snooze to cuddle girlfriend, out of bed by 07:00. One snooze is intentional and allowed — not a drift signal. Tracking "out of bed" time daily at check-in for accountability. Obstacles: girlfriend wakes later, social evenings. Flexible work (9–5 or 10–6) — shift work start, never wake time. Long-term goal: use 07:00–09:00 window for morning training sessions when double days start (~Aug).
- **Nutrition & eating pattern** (2026-03-20): Irregular meal schedule — no fixed breakfast/lunch/dinner times. Eats intuitively ("what I want to eat"), doesn't think about macros or fat content. Protein intake highly variable: some days hits target easily, other days nowhere close. Needs structural protein anchors (reliable high-protein defaults for breakfast/snack) rather than a diet overhaul. Tracking via MyFitnessPal/Cronometer confirmed this pattern (3–5 day sample, Mar 16–20). Discuss practical solutions after gala weekend.
...
- **Alcohol & recovery** (2026-03-06, updated 2026-03-16): **Pattern confirmed twice, consistent.** (1) Mar 5 heavy → Mar 6: HRV 61→31 (50% drop), sleep 6h/47/POOR. (2) Mar 12 heavy → Mar 13: HRV 73→26 (64% drop), sleep 3h/23/POOR. Both times: recovery fast — HRV back to baseline within 24–48h. Objective metrics bounce back quickly but Friday after heavy Thursday is a write-off day (devastated sleep + HRV). Planning implication: never schedule a session the day after a known heavy drinking night. Sunday 3 drinks → Monday HRV dipped modestly (68→59) — lighter drinking has smaller but still measurable impact. **Frequency concern (Week 2):** Alcohol on 5/7 nights (Mon 2, Wed 2, Thu heavy, Sun 3 — only Tue/Fri dry). Not yet affecting training outcomes at this load but worth monitoring as volume increases. Next planned drinking: March 20 gala (heavy).
- **Alcohol policy change** (2026-03-16, updated 2026-03-22): Athlete decided to stop all casual/loose drinking entirely. Only drinks on pre-planned dates below — no more random weeknight beers. **Validated through Week 3:** First full clean Mon–Fri (5 dry days). Policy holding for 2 weeks. Gala Sat: HRV 22 crash, recovered to 64 by Sunday — same alcohol→crash→bounce pattern. **Consistent finding across all 3 weeks: every heavy night costs the next day's session.** Schedule rest/easy days after planned drinking dates.
...
- **2026-03-09 — Left shin pain (run):** Slight pain appeared ~halfway through easy run (3.78 km). Walked 30 sec, resumed, pain resolved completely. NIGGLE level — no swelling, no sharp bone pain, no gait change. First occurrence. **2026-03-17: Resolved.** Ran 42 min with one brief moment of pain that resolved immediately with relaxed running. Significant improvement from first occurrence. Cleared.
- **2026-03-17 — Bilateral knee instability (run):** Both knees felt unstable during extended easy run (42 min). Not pain — more a feeling of instability. First occurrence. Likely quad/stabilizer weakness from low running volume in rebuild. Athlete self-identified and wants to address through strength training. Add single-leg stability work to lower body sessions. **2026-03-22: Clear.** No instability or discomfort on 40 min easy run (5 days after last occurrence). Continue monitoring.
...
- **2026-03-22 (updated):** Week 4 load target — progressive increase ~10-15%/week (athlete requested continued ramp, not a hold). Week 3 actual: 104. Week 4 target: ~115-120. Load spike ratio 2.26 ALERT is mathematically driven by low baseline, not excessive loading — no niggles, all injury signals improving. Rolling average will normalize within 2-3 weeks. Pull back if: niggle returns, fatigue stacks, or sleep tanks for non-social reasons. Space lower body ≥48h from runs.
- **2026-03-16:** 70.3 readiness check — every 2–3 weeks, proactively assess where athlete stands vs. 70.3 demands (1.9 km swim, 90 km bike, 21.1 km run off bike). First check ~early April. Be honest if falling behind.
...
- **2026-03-12 — Strength baseline (lower body, Week 2):** Goblet Squat 18 kg x10, RDL 30 kg x10, Split Squat (DB) 24 kg x10, Single Leg Calf Raise 10 kg x15 (15 kg too heavy — start at 10 kg), Dead Bug 10 reps. RDL: lower back fatigue noticeable when standing — normal muscle engagement, not pain. Split Squat: grip is the limiter before quads on set 1 — form calibration needed (stance/hold). **Post-session DOMS (updated 2026-03-16):** Extreme calf DOMS lasted 3+ days (Thu–Mon). Calves "on fire" all weekend — gait changes after sitting on Sat/Sun, resolving by Monday. Calf raises hit RPE 9.5–10 (started too heavy at 15 kg). This is the athlete's first structured lower body strength in a long time — expect severe DOMS on first exposures. Next session: start calf raises at 10 kg, keep volume moderate. The DOMS forced cancellation of Saturday's easy run — schedule consideration for future lower body days.
- **2026-03-19 — Strength progress (lower body, Week 3):** Goblet Squat progressed: BW x10 warmup → 18 kg x10 → 22 kg x10 (RPE 6). Split Squat 2x10 @24 kg total (RPE 7.5→8.5) — grip no longer a limiter. Single-leg calf raise 2x12 @10 kg (RPE 7→8.5) — completed both sets, huge improvement from Week 2's 15 kg disaster. RDL skipped (forgot), Dead bug skipped (didn't want to). "A little stress on the back" during goblet squats — monitor. Low energy day but completed session.
...
- **2026-03-22 — Z2 ceiling feels too low:** Can't run below 130 HR without walking. Z2 ceiling (146) feels uncomfortably slow — prefers a slightly faster tempo. Ran 7:50/km pace (Z1) at 147 avg HR (Z3). Heat was a factor. Second data point after Mar 17 where easy runs land above Z2. Zones are estimated from a 4:12 marathon — likely need recalibration via threshold test (5k TT) once base fitness is established. Until then, run by feel on easy days. Don't fight the HR monitor.
- **2026-03-22 — Aerobic fitness ahead of structural readiness:** After a 40 min/5.1 km easy run, athlete reported having to actively hold back — believes 15 km was within reach. Aerobic engine is there; the rebuild's conservative pacing is protecting connective tissue, not cardio. Good sign for the marathon long run ramp starting mid-April. Don't let this eagerness drive premature volume jumps — tendons don't adapt as fast as the heart.
- **2026-03-19 — Showing up on low energy:** Went to lower body strength despite having no energy. Proud of going. This is identity-level consistency ("I show up for myself") in action — reinforce it. Also: skipped RDL (forgot) and dead bug (didn't want to). Pattern worth watching — if exercises keep getting dropped on low-energy days, may need to restructure session order (prioritize compounds first, accessories last).
...
- **Mobility exercises in all workouts** (2026-03-16): Always include specific, named mobility exercises in workout descriptions — never just "10 min mobility" or "5 min stretching." **Strength warm-up:** dynamic mobility tailored to upper/lower split (upper: arm circles, thoracic rotations, inchworm, wall slides, band pull-aparts; lower: hip 90/90, leg swings, world's greatest stretch, ankle circles, bodyweight squat). **Strength cool-down:** static holds (upper: doorway chest stretch, child's pose, thoracic extension; lower: couch stretch, pigeon, calf/soleus stretch). **Run warm-up:** pre-run dynamic mobility before the structured warm-up jog (leg swings front/back + side/side, hip circles, walking lunges with rotation, ankle circles, calf raises). Adapt exercise selection to the session — e.g., extra shoulder care on upper body days given left shoulder history.
