...
- **Alcohol policy change** (2026-03-16, updated 2026-03-20): Athlete decided to stop all casual/loose drinking entirely. Only drinks on pre-planned dates below — no more random weeknight beers. **Week 3 validation:** First full clean week — 5 consecutive dry days (Mon–Fri) heading into the gala. No random weeknight beers. The habitual "random Tuesday 2 beers" risk didn't materialize. Policy is holding. Key risk: the habitual "random Tuesday 2 beers" is harder to resist than the big nights. No elaborate strategy yet — awareness + commitment. Schedule rest/easy days after planned drinking dates.
