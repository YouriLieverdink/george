...
- **Alcohol & recovery** (2026-03-06, updated 2026-03-07): Heavy Thursday evening → HRV crashed from 61 to 31 (50% drop, lowest since tracking began), sleep 6h/score 47/POOR, fatigue HIGH(3), motivation LOW(4), resting HR up to 59. Recovery was fast: HRV back to 61, rHR 55, sleep 7.1h/85/GOOD the following night. 2 more drinks on Friday night — back-to-back drinking nights (heavy Thu + moderate Fri). No compounding effect visible in Saturday's metrics, but worth watching.
