...
- **Alcohol & recovery** (2026-03-06, updated 2026-03-09): Heavy Thursday → HRV crashed 61→31 (50% drop), sleep 6h/47/POOR. Recovery fast: HRV back to 61 next day. 4 consecutive drinking nights (Thu heavy, Fri 2, Sat 3, Sun 2). Morning metrics recovered well each day (Mon: HRV 68, rHR 52 — both week's best), but athlete reported significant grogginess/difficulty waking despite 9.3h sleep. Likely sleep inertia from oversleeping to compensate for alcohol-degraded sleep quality. Pattern: objective metrics recover fast, subjective feel lags — body is fine but brain fog persists. 4/4 nights frequency flagged. Next planned drinking: March 20 gala. Watch closely as training ramps to 5 sessions/week in Week 2.
