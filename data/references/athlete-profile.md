...
- **Training age** (years consistently training endurance): ~2 years

## Event Priorities
- **A Race:** IRONMAN 70.3 Greece — October 25, 2026
  - Rolling bike (857m elevation), flat run (36m), calm open water swim in Gialova Bay
...
- **Marathon:** Medoc Marathon, France (September 6, 2025) — time not recorded
- **Cycling:** Amsterdam to Paris ~500km bike tour (July 2025)
- **FTP (cycling):** unknown — no power meter
- **CSS (swim):** unknown — to be tested
- **5k / 10k / Half marathon:** no recorded times

## Constraints
- **Days/week available:** 5–6
- **Max weekday session:** 1–2 hours
- **Max weekend session:** flexible, longer sessions OK
- **Preferred rest day:** none fixed
- **Work:** 32 hours/week
- **Known schedule conflicts:** vacation plans to be logged in Intervals.icu
