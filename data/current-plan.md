...
<!--
  This is the living operational state file. The coach reads and updates this
  before and after every interaction. Original training plans in plans/ stay
  unchanged — all modifications and decisions are tracked here.
-->

## Active Plans

### Primary: IRONMAN 70.3 Greece
- **Reference plan:** ironman-70.3.md
...
- **Target event:** Marathon of Groningen
- **Event date:** 2026-05-31
- **Role:** B race. No time goal. Finish comfortably, practice pacing and fueling, enjoy the hometown race.
...
- **Wednesday 08:30–09:30:** Swim course (Bosch control method, lessons 3–8 remaining)
...
| 2026-03-22 | Week 4 load above guideline — athlete-accepted | Athlete requested longer runs (+15 min each), 60 min bike (vs 35 min proposed), and added a 3rd run Wed evening (30 min). Estimated load ~165-175 vs 115-120 target. Accepted because: no niggles, all injuries resolved, motivation high, absolute load still modest. Rule: pull back if anything twinges, sleep tanks, or legs feel heavy mid-week. |
