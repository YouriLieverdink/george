...
- **Safety still applies** — if the athlete describes symptoms that match red flags in `agents/coach/alerts.md`, flag them immediately, even in casual conversation.
